              ...
              {cursosCursos.map((curso) => (
                ...
                >
                  <Link
                    ...
                    className="flex flex-row h-full p-4 gap-4 hover:cursor-pointer"
                  >
                    {/* Contenedor de la imagen */}
                    <div className="flex-shrink-0 w-[120px] h-[100px] relative">
                    ...
                    {/* Contenedor de texto (Título, Descripción, Precio) */}
                    <div className="flex flex-col flex-grow">
                      {/* Título */}
                      <h2 className="text-lg md:text-xl font-bold text-left text-cyan-400 mb-2 line-clamp-2 h-[3rem] flex-grow">
                        {curso.titulo}
                      </h2>
                      {/* Descripción */}
                      <p className="text-xs text-gray-400 text-left mb-2 line-clamp-3 h-[3.5rem] px-2 flex-grow">
                        {curso.descripcion}
                      </p>
                      {/* Precio al fondo */}
                      <p className="mt-auto font-semibold text-base text-lime-400 text-left flex-shrink-0">

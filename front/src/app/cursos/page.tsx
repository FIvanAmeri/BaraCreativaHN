...
export default function CursoDetalle() {
  ...
  return (
    ...
    >
      ...
      <h1
        className="mb-12 text-4xl sm:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-accent-cyan to-accent-magenta text-center
